...
import com.aleksander.savosh.tasker.dao.relational.BaseDao;
import com.aleksander.savosh.tasker.dao.exception.DataNotFoundException;
import com.aleksander.savosh.tasker.dao.relational.parse.ParseTransformer;
...
public abstract class AbstractParseExxDao<Obj> implements BaseDao<Obj> {

    private final Class<Obj> objClass;
    private final ParseTransformer<Obj> transformer;
    private final boolean isCloudStorage;

    public AbstractParseExxDao(Class<Obj> objClass, boolean isCloudStorage) {
